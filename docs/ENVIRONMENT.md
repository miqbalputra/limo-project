...
| `ACTIVITY_COMPLETION_ENABLED` | Opsional | Activity completion dan progres modul; default development aktif dan production nonaktif |
| `REMEDIAL_ENABLED` | Opsional | Remedial dan revisi assignment; default development aktif dan production nonaktif |
...
| `STUDENT_SELF_EXAM_ENABLED` | Opsional | Ujian daring dikerjakan mandiri oleh akun Siswa; default development aktif dan production nonaktif |
| `CLASS_DISCUSSION_ENABLED` | Opsional | Pengumuman kelas & ruang tanya jawab (diskusi); default development aktif dan production nonaktif |
