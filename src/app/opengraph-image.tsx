...
export const alt = "LIMO Little Moslems Academy";
  ...
  return new ImageResponse(
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", maxWidth: "980px" }}>
        <div style={{ color: LIMO_MEDIA_COLORS.primarySoft, display: "flex", fontSize: 28, letterSpacing: 5 }}>LITTLE MOSLEMS ACADEMY</div>
