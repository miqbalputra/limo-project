        ...
        <section key={student.id} className="tailadmin-card p-5">
          ...
          <div className="mt-4 grid gap-3 lg:grid-cols-2">
            <div className="grid gap-3">
              <select name={`presence-${student.id}`} defaultValue="HADIR" className="tailadmin-input">
              ...
              <input name={`presenceNote-${student.id}`} placeholder="Catatan presensi" className="tailadmin-input" />
            </div>
            <div className="grid gap-3">
              <select name={`score-${student.id}`} defaultValue="3" className="tailadmin-input">
              ...
              <input name={`publicNote-${student.id}`} placeholder="Catatan untuk wali" className="tailadmin-input" />
              <input name={`internalNote-${student.id}`} placeholder="Catatan internal" className="tailadmin-input" />
            </div>
          </div>
        </section>
      ))}
